          ...
          <CardContent className="p-6 space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="Software Engineer" {...field} className="h-11" /></FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="Engineering" {...field} className="h-11" /></FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="flex gap-2">
                      <FormControl>
                        <Input placeholder="Leave blank to keep current" {...field} className="h-11" />
                      </FormControl>
                      <Button 
                        type="button" 
                        variant="outline" 
            ...
            <div className="mt-6 border-t pt-6">
              <SmartRoleTool 
                ...
                onApply={(roles, perms) => {
                  // In a real app we'd handle complex state here
                }}
              />
            </div>
          </CardContent>
